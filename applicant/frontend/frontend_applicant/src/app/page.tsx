...
function ChatInterface({ showConsent, setShowChat }: ChatInterfaceProps) {
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {!scanned ? (
        <main className="flex flex-col items-center justify-center flex-1 px-6">
          ...
          {/* Flashlight bottom-left, Switch bottom-right */}
          <div className="absolute bottom-6 left-6">
            <button
              
              className="p-4 rounded-full bg-[#17293C] hover:bg-gray-700"
            >
              <Image src="/Flash Light.png" alt="Flashlight" width={30} height={30} />
            </button>
          </div>
          ...
          <div className="absolute bottom-6 right-6">
            <button
              ...
              className="p-4 rounded-full bg-[#17293C] hover:bg-gray-700"
            >
              <Image src="/Rotate Camera.png" alt="Switch Camera" width={30} height={30} />
            </button>
          </div>
        </main>
      ) : showConsent ? (
        ...
        <ChatInterface showConsent={showConsent} setShowChat={setShowChat} />
      )}
    </div>
  );
}
